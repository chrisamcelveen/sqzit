...
public class SqzitApp {

    private static final Logger log = LoggerFactory.getLogger(SqzitApp.class);

    private final Environment env;

    public SqzitApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(SqzitApp.class);
